...
if(isset($_POST['submit'])){
	if(isset($_POST['term']) === true){
		...
		$termError = '<div class="alert alert-danger alert-success alert-dismissible fade show" role="alert">
...
<div style="padding: 60px 0 40px; width:100%; box-sizing:border-box; background-color:#e74c3c;">
	<div class="flexBoxRow" style=" flex-direction: column;">
			...
			<h2 style="text-align: center; color:white; font-size:40px">Donate</h2>
          ...
          <!-- Error Messages -->
			...
			<form class="form-group" action="" method="post" style="margin-top: 20px;">
				...
				<div class="form-inline">
					...
					<span style="margin-left:10px;"><b>I agree to donate my blood t&c and show my Name, Contact Nos. and E-Mail in Blood donors List</b></span>
				</div>
				
				<div class="form-group">
					<button id="submit" name="submit" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">SignUp</button>
				</div>
				<div>Already have an account? <a href="signin.php"> Login</a></div>
			</form>
		</div>
	</div>
</div>
